    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600 ">
          <p>
            At Prescripto, We Understand The Challenges Individuals Face When It
      ...
      <div className="flex flex-col md:flex-row mb-20">
        <div className="border px-10 md:px-15 py-8 sm:py-16 flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all  duration-300 text-gray-600 cursor-pointer ">
          <b>Efficicency:</b>
          <p>
